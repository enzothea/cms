...
<? if ($widget->searchModel) : ?>
    ...
    <? if (in_array('image', $widget->searchModelAttributes)) : ?>
        <?php echo $form->fieldSelect($widget->searchModel, "image", [
    ...
    <? foreach ($properties as $property) : ?>
        <? if (in_array($property->code, $widget->realatedProperties)) : ?>
            ...
            <? if (in_array($property->property_type, [
                ...
                <?php echo $form->field($widget->searchRelatedPropertiesModel, $property->code)->checkboxList(
            ...
            <? elseif ($property->property_type == \skeeks\cms\relatedProperties\PropertyType::CODE_NUMBER) : ?>
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo $form->field($widget->searchRelatedPropertiesModel,
                ...
                <? if ($propertiesValues) : ?>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php echo $form->field($widget->searchRelatedPropertiesModel, $property->code)->dropDownList(
...
<button class="btn btn-primary"><?php echo \Yii::t('skeeks/cms', 'Apply'); ?></button>
